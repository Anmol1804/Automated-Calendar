...
def main():
  ...
  try:
    ...
    # A dict to store all events data
    event_ls = {}
    ...
    for event in events:
      ...
      # adding to dict with respect to eventID(auto generated)
      event_ls[event["id"]] = event

    # writing events data to a json file
    with open('data/event_data.json', 'w') as f:
      json.dump(event_ls, f, indent=2)
